...
class AColor {
 public:
   ...
   // lightness is from 0 to 200 as per wxColor::ChangeLightness

   static void MIDIChannel(wxDC * dc, int channel /* 1 - 16 */ , int lightness=100);
   static void LightMIDIChannel(wxDC * dc, int channel /* 1 - 16 */ , int lightness=100);
   static void DarkMIDIChannel(wxDC * dc, int channel /* 1 - 16 */ , int lightness=100);
